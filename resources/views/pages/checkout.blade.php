            ...
            <div class="row">
                    ...
                    <div class="card card-details">
                        ...
                        <div class="member mt-3">
                            ...
                            <form action="{{ route('checkout-create', $item->id) }}" class="form-inline" method="POST">
                                ...
                                <input type="text" class="form-control mb-2 mr-sm-2" name="username" id="username" required placeholder="Username">

                                <label for="nationality" class="sr-only">Nationality</label>
                                <input type="text" class="form-control mb-2 mr-sm-2" style="width:50px;" required name="nationality" id="nationality" placeholder="Nationality">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('detail', $item->travel_package->slug) }}" class="text-muted"><u>Cancel Booking</u></a>
                    </div>
                </div>
            </div>
