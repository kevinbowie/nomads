                ...
                <div class="col-lg-8 pl-lg-0">
                    <div class="card card-details">
                        ...
                        <div class="features row">
                            <div class="col-md-4">
                                <img src="{{ url('frontend/images/ic_event.png') }}" class="featured-image">
                            ...
                            <div class="col-md-4 border-left">
                                <img src="{{ url('frontend/images/ic_bahasa.png') }}" class="featured-image">
                                <div class="description">
                                    <h3>Language</h3>
                                    <p>{{ $item->language }}</p>
                                </div>
                            ...
                            <div class="col-md-4 border-left">
                                <img src="{{ url('frontend/images/ic_food.png') }}" class="featured-image">
                                <div class="description">
                                    <h3>Foods</h3>
                                    <p>{{ $item->foods }}</p>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <div class="members my-2">
                            <img src="{{ url('frontend/images/user_pic.png') }}" alt="" class="member-image mr-1">
                            <img src="{{ url('frontend/images/user_pic.png') }}" alt="" class="member-image mr-1">
                            <img src="{{ url('frontend/images/user_pic.png') }}" alt="" class="member-image mr-1">
                            <img src="{{ url('frontend/images/user_pic.png') }}" alt="" class="member-image mr-1">
                            <img src="{{ url('frontend/images/user_pic_other.png') }}" alt="" class="member-image mr-1">
                        </div>
