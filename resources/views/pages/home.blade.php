        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8 text-center">
                    <img src="{{ url('frontend/images/logo_partners.png') }}" alt="Logo Partners" class="img-partner">
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            ...
                            <h3 class="mb-4">Kevin Bowie</h3>
                            <p class="testimonial">
                                "It was a glorious and I could<br>
