                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:180px;">
                                                            <img alt="" height="auto" src="{{ url('frontend/images/logo_nomads@2x.png') }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="180" />
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                    ...
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:0px 25px;word-break:break-word;">
                                                            <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#071c4d;">Hi, {{ $data->user->name }} <br>
                                                                </br> Tiket digital kamu sudah berhasil dicetak. <br></br> Booking ID <strong>#{{ $data->id }}</strong></div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="left" style="font-size:0px;padding:25px;word-break:break-word;">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                                                <tr>
                                                                    <td align="center" bgcolor="#ff9e53" role="presentation" style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#ff9e53;" valign="middle">
                                                                        <a style="display:inline-block;background:#ff9e53;color:#ffffff;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;" href="{{ url('checkout/' . $data->id) }}">
                                                                            Check Detail
                                                                        </a>
                                                                    </td>
                                                                </tr>
